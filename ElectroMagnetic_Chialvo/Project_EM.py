...
def Project_Single_NRMSE_2023_04_20_03_08():
    ...
    モデルとNRMSEのデバッグ用．
    """
    Evaluation_EM.Evaluation_NRMSE({
        #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        "NRMSE_T_Model" : Model_EM.Model_ModifiedDeepESN,                 #モデル（Type型）
...
def Project_Single_MC_2023_05_25_13_28():
    ...
    Evaluation_EM.Evaluation_MC({
        ...
        "MemoryCapacity_T_Model" : Model_EM.Model_NormalAESN,                           #モデル（Type型）
...
def Project_EMChialvo_NRMSE_MC_2025_01_28_12_34():
    ...
    Param = {
        ...
        "EMChialvo_Reservoir_Density" : 0.8,                          #結合密度
    ...
    if Param["Project_F_NRMSE"]:
        ...
        param.update({
            ...
            #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            "DirPath_Project" : "./ElectroMagnetic_Chialvo/Results_EM/Project_EMChialvo_NRMSE_MC_2025_01_28_14_17/NRMSE",
    ...
    if Param["Project_F_MemoryCapacity"]:
        ...
        param.update({
            ...
            #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            "DirPath_Project" : "./ElectroMagnetic_Chialvo/Results_EM/Project_EMChialvo_NRMSE_MC_2025_01_28_14_17/MC",
