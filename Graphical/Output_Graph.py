    ...
    def __call__(self):
        ...
        if self.Plot_XP:
            ...
            param.update({
                ...
                "PlotXLabel" : "x",
                "PlotYLabel" : "phi",
                "PlotName" : "PhaseSpace_XandPhi.png"
            })
            Plot_Graph.Plot_PhaseSpace(param)()
        ...
        if self.Plot_YP:
            ...
            param.update({
                ...
                "PlotXLabel" : "y",
                "PlotYLabel" : "phi",
                "PlotName" : "PhaseSpace_YandPhi.png"        
                })
            Plot_Graph.Plot_PhaseSpace(param)()
