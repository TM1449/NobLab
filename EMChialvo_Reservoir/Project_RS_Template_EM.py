...
def Project_RandomSearch_NRMSE_Sample():
    ...
    if Param["Use_model"] == "ESN":
        ...
        Param_Model = Model_EM.Model_DifferentUpdateAESN
    elif Param["Use_model"] == "HubAESN":
        Param_Model = Model_EM.Model_AESNwithHubReservoir
    ...
    if Param["Evaluation"] == "NRMSE":
        ...
        NRMSE_param.update({
            ...
            "NRMSE_T_Task" : Task_EM.Task_tcVDP,                                #評価用タスク（Type型）
        ...
        Random = Random_Search_EM.RandomSearch(NRMSE_param, RS_Param)
...
def Project_RandomSearch_NRMSE_EMChialvoESN():
    ...
    if Param["Use_model"] == "EMChialvoESN":
        Param_Model = Model_EM.Model_EMChialvoESN
