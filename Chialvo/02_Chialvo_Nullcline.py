...
class Chialvo_Map(Chialvo):
    ...
    def __call__(self):
        ...
        if self.Plot_old_Nullcline:
            ...
            self.Ey = (self.c - self.b * self.X) / (1 - self.a)
        ...
        if self.Plot_new_X_Nullcline:
            ...
            self.Ex = self.X ** 2 * np.exp(((self.b - self.a + 1) * self.X - self.c) / (self.a - 1)) + self.k0 \
                + ((3 * self.k * self.beta * self.k1 ** 2) / (1 + self.k2) ** 2) * self.X ** 3 \
        ...
        if self.Plot_new_Y_Nullcline:
            ...
            self.Ex = self.a * self.Y - self.b * self.X + self.c - self.Y
            self.Ey = 1
            ...
            self.fx = (self.a * self.dy + self.c - self.dy) / self.b
            self.fy = np.log(self.dx - self.k0 - ((3 * self.k * self.beta * self.k1 ** 2) / ((self.k2 + 1) ** 2)) * self.dx ** 3 - self.dx * self.k * self.alpha) \
                - 2 * np.log(self.dx) + np.log(self.dx)
