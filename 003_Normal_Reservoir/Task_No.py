...
class Task_NormalRosslor(Task):
    ...
    #データを読み込む or 生成する
    def loadData(self):
        os.makedirs("./Normal_Reservoir/Input_Data", exist_ok=True)  # ディレクトリがなければ作成
        if os.path.exists("./Normal_Reservoir/Input_Data/NormalRosslor_data_X.npy"):
            #print("データをロードしています...")
            self.X = np.load("./Normal_Reservoir/Input_Data/NormalRosslor_data_X.npy")
            self.Y = np.load("./Normal_Reservoir/Input_Data/NormalRosslor_data_Y.npy")
            self.Z = np.load("./Normal_Reservoir/Input_Data/NormalRosslor_data_Z.npy")
            self.X_Noise = np.load("./Normal_Reservoir/Input_Data/NormalRosslor_data_X_Noise.npy")
            self.Y_Noise = np.load("./Normal_Reservoir/Input_Data/NormalRosslor_data_Y_Noise.npy")
            self.Z_Noise = np.load("./Normal_Reservoir/Input_Data/NormalRosslor_data_Z_Noise.npy")
        else:
    ...
    def makeData(self):
        ...
        np.save("./Normal_Reservoir/Input_Data/NormalRosslor_data_X.npy", self.X)
        np.save("./Normal_Reservoir/Input_Data/NormalRosslor_data_Y.npy", self.Y)
        np.save("./Normal_Reservoir/Input_Data/NormalRosslor_data_Z.npy", self.Z)
        ...
        np.save("./Normal_Reservoir/Input_Data/NormalRosslor_data_X_Noise.npy", self.X_Noise)
        np.save("./Normal_Reservoir/Input_Data/NormalRosslor_data_Y_Noise.npy", self.Y_Noise)
        np.save("./Normal_Reservoir/Input_Data/NormalRosslor_data_Z_Noise.npy", self.Z_Noise)
...
class Task_NormalLorenz(Task):
    ...
    def loadData(self):
        os.makedirs("./Normal_Reservoir/Input_Data", exist_ok=True)  # ディレクトリがなければ作成
        if os.path.exists("./Normal_Reservoir/Input_Data/NormalLorenz_data_X.npy"):
            #print("データをロードしています...")
            self.X = np.load("./Normal_Reservoir/Input_Data/NormalLorenz_data_X.npy")
            self.Y = np.load("./Normal_Reservoir/Input_Data/NormalLorenz_data_Y.npy")
            self.Z = np.load("./Normal_Reservoir/Input_Data/NormalLorenz_data_Z.npy")
            self.X_Noise = np.load("./Normal_Reservoir/Input_Data/NormalLorenz_data_X_Noise.npy")
            self.Y_Noise = np.load("./Normal_Reservoir/Input_Data/NormalLorenz_data_Y_Noise.npy")
            self.Z_Noise = np.load("./Normal_Reservoir/Input_Data/NormalLorenz_data_Z_Noise.npy")
        else:
            #print("データが見つかりません。新しく生成します...")
            self.makeData()
    ...
    def makeData(self):
        ...
        np.save("./Normal_Reservoir/Input_Data/NormalLorenz_data_X.npy", self.X)
        np.save("./Normal_Reservoir/Input_Data/NormalLorenz_data_Y.npy", self.Y)
        np.save("./Normal_Reservoir/Input_Data/NormalLorenz_data_Z.npy", self.Z)
        ...
        np.save("./Normal_Reservoir/Input_Data/NormalLorenz_data_X_Noise.npy", self.X_Noise)
        np.save("./Normal_Reservoir/Input_Data/NormalLorenz_data_Y_Noise.npy", self.Y_Noise)
        np.save("./Normal_Reservoir/Input_Data/NormalLorenz_data_Z_Noise.npy", self.Z_Noise)
...
class Task_MackeyGlass_DDE(Task):
    ...
    def loadData(self):
        os.makedirs("./Normal_Reservoir/Input_Data", exist_ok=True)  # ディレクトリがなければ作成
        if os.path.exists("./Normal_Reservoir/Input_Data/mackey_glass_data.npy"):
            #print("データをロードしています...")
            self.Y = np.load("./Normal_Reservoir/Input_Data/mackey_glass_data.npy")
            self.Y_Noise = np.load("./Normal_Reservoir/Input_Data/mackey_glass_data_Noise.npy")
        else:
            #print("データが見つかりません。新しく生成します...")
            self.makeData()
    ...
    def makeData(self):
        ...
        #データを外部ファイルに保存
        np.save("./Normal_Reservoir/Input_Data/mackey_glass_data.npy", self.Y)
        self.Y_Noise = self.Y + np.random.normal(0, self.NoiseScale, self.Y.shape)
        np.save("./Normal_Reservoir/Input_Data/mackey_glass_data_Noise.npy", self.Y_Noise)
